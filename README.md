...
- Write styles in `src/styles/main.scss` instead of `src/style.css`cd src/styles.
...
- [DEMO LINK](https://<LizaN-I>.github.io/layout_calendar/)
- [TEST REPORT LINK](https://<LizaN-I>.github.io/layout_calendar/report/html_report/)
